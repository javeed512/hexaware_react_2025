...
public class EmployeeDaoImp implements IEmployeeDao {
	...
	try {
		PreparedStatement pstmt =		conn.prepareStatement("update EmployeeInfo set ename = ? , salary = ? where eid =?");
	...
	public Employee selectByEid(int eid) {
		...
		try {
			PreparedStatement pstmt =		conn.prepareStatement("select * from EmployeeInfo where eid = ?");
	...
	public int deleteByEid(int eid) {
		...
		try {
			PreparedStatement pstmt =		conn.prepareStatement("delete from EmployeeInfo where eid = ?");
